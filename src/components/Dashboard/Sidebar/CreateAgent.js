...
const CreateAgent = (props) => {
  ...
  useEffect(() => {
    const tryLogin = async () => {
      ...
      id = transformedData.partnerCode;
  ...
  const authHandler = async () => {
    ...
    if (
      ...
      try {
        ...
        Alert.alert("Agent is successfully created");
    ...
    <ScrollView>
      <View style={styles.container}>
        ...
        <View>
          ...
          {/* <TextInput value={dateValue} style={styles.input} /> */}
          {/* <Text>{dateValue}</Text> */}
          {/* <Input
            id="dob"
            label="Date of Birth"
...
// CreateAgent.navigationOptions = (navData) => {
//   // console.log(navData);
//   return {
